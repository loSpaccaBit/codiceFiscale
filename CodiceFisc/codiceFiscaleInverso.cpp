...
void cntrl_giornoNascita(string &giornoNascita, string sesso);
/*=================================================================*/
...
#endif
void card(string codice, string codice2, string cognome, string nome, string sesso, string dataNascita, string giornoNascita, string luogoNascita, string char_cntrl, string char_cntrl2); // Stampa finales
...
int main()
{
    ...
    cl();
    card(codice, codice2, cognome, nome, sessoC, dataNascita, giornoNascita, comuneNascita, char_cntrl, char_cntrl2);
...
#endif
            cout.flush();
            cout << "Il programma verra' riavviato in 2s\n";
            slp(2);
#ifdef _WIN32
...
void card(string codice, string codice2, string cognome, string nome, string sesso, string dataNascita, string giornoNascita, string luogoNascita, string char_cntrl, string char_cntrl2)
{
    /**========================================================================
     **                           card
    ...
    cout << " ==================================================================== \n";
    cout << "|                                                                    |\n";
    cntrl_giornoNascita(giornoNascita, sesso);
    if (trv)
    {
        set_console_color(12);
        cout << "| \t"
