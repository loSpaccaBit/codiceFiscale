...
void dati(string &nome, string &cognome, string &dataNascita, string &luogoNascita, char &sesso); // Inserimento dati
...
int main()
{
    ...
    dati(nome, cognome, dataNascita, luogoNascita, sesso);
...
void dati(string &nome, string &cognome, string &dataNascita, string &luogoNascita, char &sesso)
{
    /**------------------------------------------------------------------------
     **                           dati
     *?  Inserimento dati per la generazione del codice
     *@param &nome, &cognome, &dataNascita, &luogoNascita string
     *@param &sesso char
     *@return void
     *------------------------------------------------------------------------**/
    //* Cognome
